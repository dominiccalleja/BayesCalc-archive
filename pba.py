...
def plotcBox(Cbox, save_fig = False, x_label='X'):
...
def computeConfidenceInterval(Cbox, alpha_level = 0.05, beta_level = 0.95, show_plot = False, save_fig = False, x_label='X'):
    import time 
    import datetime
...
#def envelopeOfCbox(Cbox1, Cbox2):
#    
#    if Cbox1.get('betaparam') == 'unknown' and Cbox2.get('betaparam') == 'unknown' and C:
#        
#        lower_1 = Cbox1.get('lb')
#        lower_2 = Cbox2.get('lb')
#        
#        upper_1 = Cbox1.get('ub')
#        upper_2 = Cbox2.get('ub')
...
#    return {'support' : x, 'lb': average_lower, 'ub': average_upper, 'betaparam': 'unknown', 'flag': flag} 
# 
def computeFocalElements(Cbox, npoints = 100, show_plot = False, x_label='X'):
